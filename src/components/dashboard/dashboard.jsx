...
import {Mentor as MentorCard, Task as TaskCard} from '../common/cards/cards.jsx';
import Header from '../common/header/header.jsx';

import './dashboard.sass';
import './dashboard-mobile.sass';
    ...
    return(
        <div className="dashboard">
            <div className="dashboard__general grid">
                ...
                <Slider size={2} className='grid__slider' title="Monthly mentors" collection={collectMentors()} />

                <Slider size={2} className='grid__slider' title="Upcoming task" collection={collectTasks()}/>
